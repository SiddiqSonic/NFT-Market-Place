...
const Layout =({children}) =>{
  ...
  const [isModalVisible, setIsModalVisible] = useState(false);
    ...
    <div className="col-md-12 mybody">
        ...
        <div className="  mycontainer   m-4  ">
            <div className="col-md-12 p-3 topbody">
                <div className="">
                    <NavLink to='/MetaPlayer' type="button" className="btncolor btn btn-secondary">Meta Players</NavLink>
                    <NavLink to='/Guns'  type="button" className="btncolor btn btn-secondary">Guns</NavLink>
                    <NavLink to='/NftBox'  type="button" className="btncolor btn btn-secondary">NFT's Box (coming soon)</NavLink>
                    <NavLink to='/Car'  type="button" className="btncolor btn btn-secondary">Car (coming soon)</NavLink>
                    <NavLink to='/Walls'  type="button" className="btncolor btn btn-secondary">Walls (coming soon)</NavLink>
                </div>
            </div>
            <hr></hr>
