...
function NFTTokenIds({ inputValue, setInputValue, Mynft, setnft, path, match }) {
  ...
  setInputValue("0xcBcD639ea00e9Ee222d4847cC0318cB0f3258Ff2");
  const fallbackImg =
  ...
  const queryMarketItems = useMoralisQuery("ListedPP");
  ...
  const purchaseItemFunction = "buyNFTWithToken";
    ...
    <>
      <div>
        ...
        {path !== "Buy" &&
          NFTTokenIds.slice(0, 20).map((nft, index) => (
            ...
            <div>
              ...
              {getMarketItem(nft) && (
                <div className="mynft m-3 text-center">
                  <NavLink to={`/buy/${MarketList.objectId}`} >

                    <p className=" m-3 p-1  tag ">
                      <span className="">Meta Players</span>
                      <img src="asset/images/attack.png" alt="" className="power p1 ml-2" />
                      <img src="asset/images/health.png" alt="" className="power p2 ml-2" />
                    </p>
                    <img src={nft?.image || "error"} className="character" alt="" />
                    <p className="chinfo"> #{nft.token_id} {nft.name}</p>
                    <h5 className="chinfo"> {MarketList.price / ("1e" + 18)} MPL</h5>
                  </NavLink>
                  <button className="btn btn-primary" onClick={() => purchase(getMarketItem(nft).objectId)} >Buy Now</button>
                </div>
        ...
        {path === 'Buy' &&
          ...
          //               <div data-v-c7994836="" className="title span col-md-6"><span data-v-c7994836="" className="token-id-m">#1</span  >{BuyNftItem.Name }</div>
          //             </div>
          ...
          //                                         stars-large"></div>
          //             </div>
          //             <model-viewer alt="Neil Armstrong's Spacesuit from the Smithsonian Digitization Programs Office and National Air and Space Museum" src={`asset/images/gltf/${my_nft.tokenId}.gltf`} poster="shared-assets/models/NeilArmstrong.webp" seamless-poster="" shadow-intensity="1" camera-controls="" ar-status="not-presenting"></model-viewer>
          //           </div>
          //           {/* ModelUrl */}
          ...
          //             <div data-v-c7994836="" className="title">GROWTH POTENTIAL<span data-v-c7994836="" className="title-text" style={{ color: "rgb(136, 173,219)" }}>({BuyNftItem.ATTACK + BuyNftItem.HEALTH+BuyNftItem.DEFENCE+BuyNftItem.SPEED})</span></div>
          ...
          //                                                 bg-box" style={{ backgroundImage: "url( asset/images/attack.png)" }}></div><span data-v-c7994836="">{BuyNftItem.ATTACK }</span></div>
          //               </div>
          //               <div data-v-c7994836="" className="data-item">
          //                 <div data-v-c7994836="" className="s-title">HEALTH</div>
          //                 <div data-v-c7994836="" className="s-value">
          //                   <div data-v-9f0486de="" data-v-c7994836="" className="cover-image
          //                                                 bg-box" style={{ backgroundImage: "url( asset/images/health.png)" }}></div><span data-v-c7994836="">{BuyNftItem.HEALTH }</span></div>
          //               </div>
          //               <div data-v-c7994836="" className="data-item">
          //                 <div data-v-c7994836="" className="s-title">DEFENCE</div>
          //                 <div data-v-c7994836="" className="s-value">
          //                   <div data-v-9f0486de="" data-v-c7994836="" className="cover-image
          //                                                 bg-box" style={{ backgroundImage: "url( asset/images/protection.png)" }}></div><span data-v-c7994836="">{BuyNftItem.DEFENCE }</span></div>
          //               </div>
          //               <div data-v-c7994836="" className="data-item">
          //                 <div data-v-c7994836="" className="s-title">SPEED</div>
          //                 <div data-v-c7994836="" className="s-value">
          //                   <div data-v-9f0486de="" data-v-c7994836="" className="cover-image
          //                                                 bg-box" style={{ backgroundImage: "url( asset/images/speedcopy.png)" }}></div><span data-v-c7994836=" ">{BuyNftItem.SPEED }</span></div>
          //               </div>
          ...
          <div className="row">
            <div className="col-md-6 p-5">
              <div className="modeltop row">
                <div className="col-md-6">
                  <h3 className="text-white">{BuyNftItem.Name}</h3>
                </div>
                <div class="col-md-6 text-center">
                  <img src="asset/images/health.png" className="img " alt="" />
                  <img src="asset/images/attack.png" className="img" alt="" />
                </div>
              </div>
              <model-viewer alt="Neil Armstrong's Spacesuit from the Smithsonian Digitization Programs Office and National Air and Space Museum" src={`asset/gltf/${my_nft.tokenId}.gltf`} poster="shared-assets/models/NeilArmstrong.webp" seamless-poster="" shadow-intensity="1"
                camera-controls="" ar-status="not-presenting"></model-viewer>
              <div className="modeltop row p-3">
                <div className="col-md-6 text-center">
                  <img src="asset/images/bnb.png" className="mybnb" alt="" />
                  <b className="m-3">{my_nft.price / ("1e" + 18)}</b>
                </div>
                <div className="col-md-6 text-center">
                 
                  <button onClick={() => purchase(id)} className="btn btn-primary btn-sm ">Buy Now</button>
                </div>
              </div>
            </div>
            <div className="col-md-6 p-3">
              <div className="mt-5 p-5 mypowers">
                <h5 className="text-white">GROWTH POTENTIAL( {BuyNftItem.ATTACK + BuyNftItem.HEALTH + BuyNftItem.SPEED + BuyNftItem.DEFENCE})</h5>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="text-white">ATTACK</h6>
                    <h6 className="text-white"><img src="asset/images/attack.png" className="img" alt="" /> ( {BuyNftItem.ATTACK} )</h6>
                  </div>
                  <div className="col-md-6">
                    <h6 className="text-white">HEALTH</h6>
                    <h6 className="text-white"> <img src="asset/images/health.png" className="img" alt="" /> ( {BuyNftItem.HEALTH} )</h6>
                  </div>
                </div>
                <div className="row mt-3">
                  <div className="col-md-6 mt-2">
                    <h6 className="text-white">SPEED</h6>
                    <h6 className="text-white"> <img src="asset/images/speedcopy.png" className="img" alt="" />( {BuyNftItem.SPEED} )</h6>
                  </div>
                  <div className="col-md-6">
                    <h6 className="text-white">DEFENCE</h6>
                    <h6 className="text-white"> <img src="asset/images/protection.png" className="img" alt="" /> ( {BuyNftItem.DEFENCE} )</h6>
                  </div>
                </div>
              </div>
            </div>
