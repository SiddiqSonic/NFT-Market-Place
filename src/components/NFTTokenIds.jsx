...
function NFTTokenIds({ inputValue, setInputValue,Mynft, setnft, path,match }) {
  setInputValue("0x5a36F9f168Fed4c5bFF70aAE0Ac1b19CECd38665");
  const fallbackImg =
  ...
  const queryMarketItems = useMoralisQuery("ListedMarketItems");
  ...
  async function updateSoldMarketItem(objId) {
    ...
    const marketList = Moralis.Object.extend("ListedMarketItems");
...
if (path == "Buy"){
  getNftModel("https://sov4nxuxgz71.usemoralis.com:2053/server/functions/getNFT?_ApplicationId=1lHRghK2KvhvHNkoKxiA9SWXsH3RxytBjsOrbqxw&id="+getNft(id).tokenId);
